      ...
      <main className="px-4 py-4 sm:px-6 sm:py-6">
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-6">
          <section className="rounded-[2rem] border border-black/6 bg-white/80 px-6 py-16 shadow-[0_24px_80px_rgba(15,23,42,0.08)] sm:px-10 sm:py-20 dark:bg-neutral-900 dark:border-white/10">
            ...
            <div className="mt-6 rounded-2xl border border-black/6 bg-white/60 px-5 py-4 backdrop-blur dark:bg-white/5 dark:border-white/10">
              <p className="text-sm text-neutral-500 dark:text-neutral-400">
                Try searching for a color by name, hex code, or family —{" "}
                <Link href="/all-colors/" className="font-medium text-neutral-950 underline underline-offset-2 transition hover:text-neutral-700 dark:text-white dark:hover:text-neutral-300">
                  go to search
                </Link>
              </p>
            </div>
