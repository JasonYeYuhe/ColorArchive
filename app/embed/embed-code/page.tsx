...
export const metadata: Metadata = {
  ...
  description:
    "Add a free color picker widget to your website. Embed the ColorArchive color picker with hex, RGB, HSL values and 3,000+ curated colors in a single iframe.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Add a free color picker widget to your website with hex, RGB, HSL values and 3,000+ curated colors.",
