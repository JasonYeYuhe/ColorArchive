...
enum CollectionsData {
    static let all: [ColorCollection] = [
        ...
        ColorCollection(id: "arctic-dawn", title: "Arctic Dawn", summary: "Pale lavender and icy blue for ethereal cold themes.", tags: ["Cold", "Ethereal", "Pastel"], colorIds: ["iris-veil-faint", "azure-whisper-muted", "iris-mist-soft", "cool-gray-veil", "violet-pearl-faint"], useCases: ["Spa brands", "Meditation apps", "Winter campaigns"]),
