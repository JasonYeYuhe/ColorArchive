    ...
    <main className="px-4 py-4 sm:px-6 sm:py-6">
      <div className="mx-auto flex w-full max-w-[1600px] flex-col gap-6">
        ...
        <section className="relative overflow-hidden rounded-[2rem] border border-black/6 bg-white/74 px-6 py-10 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-white/10 dark:bg-neutral-900/74 sm:px-10 sm:py-14">
          <div className="pointer-events-none absolute left-0 top-8 h-52 w-52 rounded-full bg-rose-200/28 blur-3xl dark:bg-rose-800/15" />
          <div className="pointer-events-none absolute right-0 top-0 h-64 w-64 rounded-full bg-sky-200/28 blur-3xl dark:bg-sky-800/15" />
          <div className="relative mx-auto max-w-4xl">
            ...
            <h1 className="max-w-3xl text-4xl font-semibold tracking-[-0.04em] text-neutral-950 dark:text-white sm:text-6xl">
              {t("allColors.title")}
            </h1>
