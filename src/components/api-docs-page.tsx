    ...
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mb-10">
        ...
        <p className="mt-3 max-w-xl text-neutral-500 dark:text-neutral-400">
          Access all 5,446 curated ColorArchive colors via a simple REST API. Free, no auth required, CORS enabled.
        </p>
      </div>
      ...
      <div className="space-y-10">
        ...
        <section className="rounded-2xl border border-black/6 bg-white/60 p-6 dark:border-white/8 dark:bg-white/4">
          ...
          <p className="mb-5 text-sm text-neutral-600 dark:text-neutral-400">
            Search, filter, and paginate through 5,446 colors. Supports semantic search — try queries like &quot;sunset&quot;, &quot;ocean&quot;, or &quot;minimal&quot;.
          </p>
...
console.log(colors[0].hex); // "#8B2500"`}</code>
        ...
        <section className="rounded-2xl border border-black/6 bg-white/60 p-6 dark:border-white/8 dark:bg-white/4">
          ...
          <ul className="space-y-2 text-sm text-neutral-600 dark:text-neutral-400">
            ...
            <li>All 5,446 colors are generated algorithmically — the dataset is stable and deterministic.</li>
          </ul>
        </section>
      </div>
    </main>
