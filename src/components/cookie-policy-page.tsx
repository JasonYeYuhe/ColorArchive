...
- **Session cookie**: A single authentication cookie that keeps you logged in after signing in via magic link or Google OAuth. This cookie is essential for account features such as favorites sync, purchase history, and API key management.
...
- **Payment provider**: When you are redirected to our payment provider's checkout page, their cookies and privacy policy apply during that session.
...
Please note that disabling the session cookie will prevent you from staying logged in, and clearing localStorage will remove your locally saved favorites and preferences.`,
  ...
  },
  {
    title: "7. Contact",
    content:
      "If you have questions about our use of cookies, please contact us at **support@colorarchive.me**.",
  },
];
