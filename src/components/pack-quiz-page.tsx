...
const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: { en: "Everything — the full 5,000+ color archive", ja: "全部 — 5,000+色の完全アーカイブ" }, scores: { "complete-archive": 3, "all-access-bundle": 2 } },
    ],
  },
  {
    id: "format",
...
const PACK_META: Record<string, { title: string; desc: LocaleText; href: string; accent: string }> = {
  ...
  "complete-archive": { title: "Complete Archive Token Set", desc: { en: "All 5,000+ colors in 16+ formats including SwiftUI, Android, Flutter, and WCAG reports.", ja: "SwiftUI、Android、Flutter、WCAGレポートを含む16以上の形式で全5,000+色。" }, href: "/packs/complete-archive/", accent: "bg-sky-50 border-sky-200/60" },
