...
const SEARCH_ALIASES: Record<string, string[]> = {
  ...
  // --- Scandinavian / Nordic winter ---
  scandinavian_winter: ["cool-gray", "cerulean", "cobalt"],
  nordic_winter_palette: ["cool-gray", "cobalt", "cerulean"],
  nordic_palette: ["cool-gray", "cobalt", "cerulean", "teal"],
  nordic_style: ["cool-gray", "true-gray", "cobalt"],
  snow_white_palette: ["cool-gray", "true-gray", "cerulean"],
  icy_blue: ["cerulean", "cobalt", "cool-gray"],
  winter_white: ["cool-gray", "true-gray", "cobalt"],
  nordic_colors: ["cool-gray", "cobalt", "cerulean"],
  hygge_palette: ["warm-gray", "amber", "cool-gray"],
  nordic_minimal: ["cool-gray", "true-gray", "cobalt"],

  // --- Golden Hour / Magic Hour ---
  golden_hour_colors: ["amber", "apricot", "coral", "rose"],
  magic_hour_palette: ["amber", "apricot", "rose", "coral"],
  golden_hour_scheme: ["amber", "apricot", "coral", "rose"],
  sunset_warm: ["amber", "apricot", "ember", "coral"],
  rose_gold_palette: ["rose", "amber", "apricot", "coral"],
  warm_glow: ["amber", "apricot", "coral", "warm-gray"],
  photography_warm: ["amber", "apricot", "rose", "coral"],
  dusk_palette: ["amber", "rose", "violet", "apricot"],
  golden_light: ["amber", "apricot", "citrine"],
  warm_sunset: ["amber", "ember", "apricot", "coral"],

  // --- Forest Bathing / Biophilic ---
  forest_bathing: ["leaf", "moss", "emerald", "olive"],
  shinrin_yoku_palette: ["leaf", "moss", "emerald", "amber"],
  biophilic_palette: ["leaf", "moss", "emerald", "teal"],
  biophilic_style: ["leaf", "moss", "teal", "amber"],
  forest_green_palette: ["leaf", "emerald", "moss", "teal"],
  nature_wellness: ["leaf", "moss", "olive", "teal"],
  woodland_palette: ["leaf", "moss", "olive", "amber"],
  green_wellness: ["leaf", "moss", "emerald", "teal"],
  deep_forest: ["emerald", "leaf", "moss", "teal"],
  forest_floor: ["moss", "olive", "amber", "warm-gray"],

  // --- Industrial / Concrete / Urban ---
  industrial_palette: ["warm-gray", "true-gray", "cool-gray", "ember"],
  concrete_colors: ["true-gray", "cool-gray", "warm-gray"],
  industrial_modern: ["warm-gray", "true-gray", "ember", "amber"],
  loft_aesthetic: ["warm-gray", "true-gray", "ember"],
  raw_concrete: ["true-gray", "cool-gray", "warm-gray"],
  concrete_and_steel: ["cool-gray", "true-gray", "warm-gray"],
  urban_industrial: ["warm-gray", "true-gray", "cool-gray", "ember"],
  charcoal_palette: ["true-gray", "cool-gray", "warm-gray"],
  industrial_chic: ["warm-gray", "ember", "true-gray"],
  reclaimed_palette: ["warm-gray", "amber", "ember", "true-gray"],

  // --- Tropical Garden / Vivid Botanical ---
  tropical_palette: ["fuchsia", "lime", "teal", "ember"],
  tropical_garden: ["fuchsia", "lime", "emerald", "cerulean"],
  tropical_botanical: ["fuchsia", "lime", "teal", "emerald"],
  vivid_botanical: ["fuchsia", "lime", "teal", "emerald"],
  tropical_vivid: ["fuchsia", "lime", "teal", "cerulean"],
  botanical_vivid: ["fuchsia", "lime", "teal", "emerald"],
  bougainvillea: ["fuchsia", "peony", "rose"],
  maximalist_palette: ["fuchsia", "lime", "teal", "amber"],
  jungle_palette: ["emerald", "lime", "teal", "fuchsia"],
  tropical_color: ["fuchsia", "lime", "teal", "cerulean"],

  // --- Art Nouveau / Ornamental Heritage ---
  art_nouveau_style: ["teal", "iris", "amber", "moss", "plum"],
  art_nouveau_palette: ["teal", "iris", "amber", "moss"],
  peacock_palette: ["teal", "cobalt", "iris", "emerald"],
  belle_epoque: ["teal", "iris", "amber", "rose"],
  ornamental_palette: ["teal", "iris", "amber", "moss"],
  nouveau_revival: ["teal", "iris", "amber", "moss"],
  mucha_palette: ["teal", "iris", "rose", "amber"],
  peacock_colors: ["teal", "cobalt", "iris", "emerald"],
  heritage_ornamental: ["teal", "iris", "amber", "plum"],
  art_deco_revival: ["amber", "cobalt", "plum", "teal"],

  // --- Nordic Summer / Midsummer ---
  nordic_summer: ["cerulean", "rose", "citrine", "blush"],
  midsummer_palette: ["cerulean", "blush", "citrine", "moss"],
  midsommar: ["cerulean", "blush", "citrine", "rose"],
  scandinavian_summer: ["cerulean", "blush", "citrine", "cool-gray"],
  pale_summer: ["cerulean", "blush", "citrine", "cool-gray"],
  summer_pastels: ["cerulean", "blush", "citrine", "rose"],
  nordic_pastoral: ["cerulean", "blush", "moss", "citrine"],
  midsummer_festival: ["blush", "cerulean", "citrine", "rose"],
  pale_blue_palette: ["cerulean", "cobalt", "cool-gray"],
  light_summer: ["cerulean", "blush", "citrine", "cool-gray"],

  // --- Canyon / Southwest Desert Dusk ---
  canyon_dusk: ["ember", "apricot", "violet", "amber"],
  canyon_colors: ["ember", "apricot", "amber", "rose"],
  southwest_palette: ["ember", "apricot", "amber", "violet"],
  desert_dusk_palette: ["ember", "apricot", "violet", "amber"],
  red_rock_palette: ["ember", "coral", "apricot", "amber"],
  arizona_palette: ["ember", "apricot", "amber", "rose"],
  canyon_sunset: ["ember", "apricot", "amber", "rose"],
  sandstone_palette: ["ember", "apricot", "amber", "warm-gray"],
  mesa_colors: ["ember", "apricot", "amber", "warm-gray"],
  utah_palette: ["ember", "coral", "violet", "amber"],
};
