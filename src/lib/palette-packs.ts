...
export const palettePacks: PalettePack[] = [
  {
    ...
    previewCollectionIds: ["quiet-luxury", "modern-seaside", "editorial-warmth"],
    formatList: ["CSS variables", "Tailwind tokens", "PNG boards", "Usage notes"],
    deliverables: [
      "12 curated five-color palette boards",
  ...
  },
  {
    ...
    previewCollectionIds: ["quiet-luxury", "nocturne-tech", "orchid-bloom"],
  ...
  },
  {
    ...
    previewCollectionIds: ["modern-seaside", "orchid-bloom"],
