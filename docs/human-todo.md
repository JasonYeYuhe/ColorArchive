...
> Last updated: 2026-03-22 (normal run — Newsletter 078-081, 2 guides, 2 collections, search aliases)
...
- [ ] Review new collections added in recent runs (morning-ceramic, forest-depths, sunset-terrace, deep-tide) — confirm color IDs render correctly in live UI
...
- [ ] Review new SEO guides (dark-mode-color-palette, neutral-color-palettes, analogous-color-palette, color-palette-for-healthcare) — confirm they render at /guides/{slug}/
